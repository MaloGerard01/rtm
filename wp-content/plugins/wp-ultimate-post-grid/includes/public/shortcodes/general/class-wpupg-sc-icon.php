		...
		if ( 'separate' === $atts['style'] ) {
			...
			if ( 'line' === $atts['decoration'] ) {
				if ( 'left' === $atts['align'] || 'center' === $atts['align'] ) {
					$after_icon = '<div class="wpupg-decoration-line" style="border-color: ' . $atts['line_color'] . '"></div>';
				}
				if ( 'right' === $atts['align'] || 'center' === $atts['align'] ) {
					$before_icon = '<div class="wpupg-decoration-line" style="border-color: ' . $atts['line_color'] . '"></div>';
				}
			}
		}
